    ...
    for row in build_rows:
        ...
        if role_rowspan:
            ...
            if weapon_rowspan:
                ...
                colspan = __get_colspan(weapon_cell) - 1

                weapons = __extract_text(weapon_cell).strip()
                prev_text = weapons
                previous_row.weapons += "\n\n" + weapons
            ...
            if talent_priority_rowspan:
                ...
                colspan -= 1
                talent_priority = prev_text
                previous_row.talent_priority += "\n\n" + talent_priority
            else:
                ...
                colspan = __get_colspan(talent_priority_cell) - 1

                talent_priority = __extract_text(talent_priority_cell).strip()
                prev_text = talent_priority
                previous_row.talent_priority += "\n\n" + talent_priority
            ...
            if ability_tip_rowspan:
                ...
                colspan -= 1
                ability_tips = prev_text
                previous_row.ability_tips += "\n\n" + ability_tips
            else:
...
def __get_rowspan(cell: Tag) -> int:
    return int(cell.attrs.get("rowspan", "1"))


def __get_colspan(cell: Tag) -> int:
    return int(cell.attrs.get("colspan", "1"))
